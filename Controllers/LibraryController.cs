            ...
            var body = $"""
                <html>
                    <body>
                        ...
                        <h2>
                            Your account has been created and we have sent approval request to librarian. 
                            Once the request is approved by librarian you will receive email, and you will be
                    ...
                    EmailService.SendEmail(user.Email, "Account Approved", $"""
                        <html>
                            <body>
                                ...
                                <h3>You Account has been approved by librarian.</h3>
